...
# [START gke_postgres_vpc_multi_region_network]
module "gcp-network" {
...
module "firewall_rules" {
  ...
  ingress_rules = [{
    ...
    description             = "connection between Postgres clusters"
...
# [END gke_postgres_vpc_multi_region_network]

# [START gke_postgres_cloudnat_simple_create]
...
# [END gke_postgres_cloudnat_simple_create]
