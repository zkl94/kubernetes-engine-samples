...
module "firewall_rules" {
  ...
  ingress_rules = [{
    ...
    description             = "connection between Redis clusters"
    source_ranges           = ["10.48.0.0/20","10.54.0.0/20"]
    allow = [{
      protocol = "tcp"
      ports    = ["6379","8080","9081","9443","10000-19999"]
    }]
    deny = []
  }]
}
...
# [END gke_redis_vpc_multi_region_network]

# [START gke_redis_cloudnat_simple_create]
...
# [END gke_redis_cloudnat_simple_create]
