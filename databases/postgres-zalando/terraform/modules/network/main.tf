...
# [START gke_postgres_zalando_vpc_multi_region_network]
module "gcp-network" {
...
# [END gke_postgres_zalando_vpc_multi_region_network]

# [START gke_postgres_zalando_cloudnat_simple_create]
module "cloud_router" {
...
# [END gke_postgres_zalando_cloudnat_simple_create]
