...
# [START gke_streaming_kafka_confluent_vpc_multi_region_network]
module "gcp-network" {
...
# [END gke_streaming_kafka_confluent_vpc_multi_region_network]

# [START gke_streaming_kafka_confluent_cloudnat_simple_create]
...
# [END gke_streaming_kafka_confluent_cloudnat_simple_create]
