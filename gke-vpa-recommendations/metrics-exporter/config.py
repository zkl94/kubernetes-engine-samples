...
class MetricConfig:
    ...
    """
    def __init__(self, metric: str, window: int, seconds_between_points: int, data_type: str,
                 per_series_aligner: monitoring_v3.types.Aggregation.Aligner, 
                 cross_series_reducer: monitoring_v3.types.Aggregation.Reducer, columns: [str]):
        self.metric = metric
        self.window = window
